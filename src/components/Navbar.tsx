      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4 sm:gap-6 min-w-0">
            <div id="header-brand" className="flex items-center gap-2.5 sm:gap-3 min-w-0">
              {/* Icon Container */}
              ...
              {/* Vertical Text Container with Overflow Fixes */}
              <div className="flex flex-col justify-center min-w-0">
                <h1
                  id="header-brand-title"
                  className="text-sm sm:text-base font-bold tracking-tight text-zinc-900 dark:text-zinc-50 leading-tight truncate"
          ...
          {/* Actions */}
          <div id="header-actions" className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            {user ? (
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 sm:px-4 py-2 text-xs font-semibold bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 rounded-lg hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors cursor-pointer shadow-xs"
                >
                ...
                <div
                  ...
                  className="flex items-center gap-2 px-2 sm:px-2.5 py-1.5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-lg"
                >
                  {user.photoURL ? (
                    <img
              ...
              <button
                ...
                onClick={onLogin}
                className="flex items-center gap-2 px-3 sm:px-4 py-2 text-xs font-semibold bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer shadow-xs"
              >
